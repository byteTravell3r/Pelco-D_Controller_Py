...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMinimumSize(QtCore.QSize(1120, 640))
        font = QtGui.QFont()
...
"")
        ...
        self.BOX_COM_LST = QtWidgets.QComboBox(parent=self.groupBox_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.MinimumExpanding, QtWidgets.QSizePolicy.Policy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.BOX_COM_LST.sizePolicy().hasHeightForWidth())
        self.BOX_COM_LST.setSizePolicy(sizePolicy)
        self.BOX_COM_LST.setMinimumSize(QtCore.QSize(0, 36))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(12)
        font.setBold(True)
        self.BOX_COM_LST.setFont(font)
        self.BOX_COM_LST.setEditable(True)
        self.BOX_COM_LST.setPlaceholderText("")
        self.BOX_COM_LST.setDuplicatesEnabled(True)
        self.BOX_COM_LST.setFrame(True)
        self.BOX_COM_LST.setObjectName("BOX_COM_LST")
        self.horizontalLayout_2.addWidget(self.BOX_COM_LST)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.BTN_SET_COM.sizePolicy().hasHeightForWidth())
        self.BTN_SET_COM.setSizePolicy(sizePolicy)
        ...
        self.BTN_SET_COM.setCheckable(True)
        self.BTN_SET_COM.setChecked(True)
...
"")
        ...
        self.horizontalLayout_8.setContentsMargins(4, 5, 4, 5)
        ...
        self.BOX_FILE = QtWidgets.QLineEdit(parent=self.groupBox_7)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.BOX_FILE.sizePolicy().hasHeightForWidth())
        self.BOX_FILE.setSizePolicy(sizePolicy)
        self.BOX_FILE.setMinimumSize(QtCore.QSize(0, 36))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(12)
        font.setBold(True)
        self.BOX_FILE.setFont(font)
        self.BOX_FILE.setStyleSheet("QLineEdit\n"
"{\n"
"    background-color: qlineargradient(spread:repeat, x1:1, y1:0, x2:1, y2:1, stop:0 rgba(118, 118, 118, 255),stop:1 rgba(70, 70, 70, 255));\n"
"    border: 1px solid #333333;\n"
"    border-radius: 3px;\n"
...
"\n"
"}")
        self.BOX_FILE.setReadOnly(True)
        self.BOX_FILE.setClearButtonEnabled(False)
        self.BOX_FILE.setObjectName("BOX_FILE")
        self.horizontalLayout_8.addWidget(self.BOX_FILE)
        self.BTN_OPEN = QtWidgets.QPushButton(parent=self.groupBox_7)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.BTN_OPEN.sizePolicy().hasHeightForWidth())
        self.BTN_OPEN.setSizePolicy(sizePolicy)
        self.BTN_OPEN.setMinimumSize(QtCore.QSize(105, 36))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.EXEC_CTRL = QtWidgets.QGroupBox(parent=self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.EXEC_CTRL.sizePolicy().hasHeightForWidth())
        self.EXEC_CTRL.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(11)
        font.setBold(True)
        self.EXEC_CTRL.setFont(font)
        self.EXEC_CTRL.setObjectName("EXEC_CTRL")
        self.horizontalLayout_7 = QtWidgets.QHBoxLayout(self.EXEC_CTRL)
        self.horizontalLayout_7.setContentsMargins(4, 5, 4, 5)
        self.horizontalLayout_7.setSpacing(8)
        self.horizontalLayout_7.setObjectName("horizontalLayout_7")
        self.LCD_LINE_NUM = QtWidgets.QLCDNumber(parent=self.EXEC_CTRL)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.MinimumExpanding, QtWidgets.QSizePolicy.Policy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.LCD_LINE_NUM.sizePolicy().hasHeightForWidth())
        self.LCD_LINE_NUM.setSizePolicy(sizePolicy)
        self.LCD_LINE_NUM.setMinimumSize(QtCore.QSize(60, 50))
        self.LCD_LINE_NUM.setAutoFillBackground(False)
        self.LCD_LINE_NUM.setStyleSheet("QLCDNumber\n"
"{\n"
"    background-color: #00000000\n"
"}\n"
"")
        self.LCD_LINE_NUM.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.LCD_LINE_NUM.setDigitCount(2)
        self.LCD_LINE_NUM.setProperty("intValue", 0)
        self.LCD_LINE_NUM.setObjectName("LCD_LINE_NUM")
        self.horizontalLayout_7.addWidget(self.LCD_LINE_NUM)
        self.BTN_RUN = QtWidgets.QPushButton(parent=self.EXEC_CTRL)
        ...
        self.BTN_RUN.setMinimumSize(QtCore.QSize(130, 50))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.BTN_RUN.setAutoExclusive(True)
        self.BTN_RUN.setObjectName("BTN_RUN")
        self.horizontalLayout_7.addWidget(self.BTN_RUN)
        self.BTN_PAUSE = QtWidgets.QPushButton(parent=self.EXEC_CTRL)
        ...
        self.BTN_PAUSE.setMinimumSize(QtCore.QSize(130, 50))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.BTN_PAUSE.setAutoExclusive(True)
        self.BTN_PAUSE.setObjectName("BTN_PAUSE")
        self.horizontalLayout_7.addWidget(self.BTN_PAUSE)
        self.BTN_STOP_PROG = QtWidgets.QPushButton(parent=self.EXEC_CTRL)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.BTN_STOP_PROG.sizePolicy().hasHeightForWidth())
        self.BTN_STOP_PROG.setSizePolicy(sizePolicy)
        self.BTN_STOP_PROG.setMinimumSize(QtCore.QSize(130, 50))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(12)
        font.setBold(True)
        self.BTN_STOP_PROG.setFont(font)
        self.BTN_STOP_PROG.setCheckable(True)
        self.BTN_STOP_PROG.setChecked(True)
        self.BTN_STOP_PROG.setAutoExclusive(True)
        self.BTN_STOP_PROG.setObjectName("BTN_STOP_PROG")
        self.horizontalLayout_7.addWidget(self.BTN_STOP_PROG)
        self.verticalLayout_2.addWidget(self.EXEC_CTRL)
        ...
        self.horizontalLayout_5.setContentsMargins(4, 5, 4, 5)
        ...
        self.BTN_SET_H_POS.setMinimumSize(QtCore.QSize(0, 50))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.BTN_SET_V_POS.setMinimumSize(QtCore.QSize(0, 50))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(12)
        font.setBold(True)
...
"")
        ...
        self.BTN_STOP.toggled['bool'].connect(self.BTN_RUN.setEnabled) # type: ignore
        self.BTN_STOP.toggled['bool'].connect(self.BTN_STOP_PROG.setEnabled) # type: ignore
        self.BTN_STOP.toggled['bool'].connect(self.BTN_PAUSE.setEnabled) # type: ignore
        self.BTN_RUN.toggled['bool'].connect(self.BTN_UPLT.setDisabled) # type: ignore
        self.BTN_RUN.toggled['bool'].connect(self.BTN_UP.setDisabled) # type: ignore
        self.BTN_RUN.toggled['bool'].connect(self.BTN_UPRT.setDisabled) # type: ignore
        self.BTN_RUN.toggled['bool'].connect(self.BTN_LT.setDisabled) # type: ignore
        self.BTN_RUN.toggled['bool'].connect(self.BTN_RT.setDisabled) # type: ignore
        self.BTN_RUN.toggled['bool'].connect(self.BTN_DNLT.setDisabled) # type: ignore
        self.BTN_RUN.toggled['bool'].connect(self.BTN_DN.setDisabled) # type: ignore
        self.BTN_RUN.toggled['bool'].connect(self.BTN_DNRT.setDisabled) # type: ignore
        self.BTN_RUN.toggled['bool'].connect(self.BTN_STOP.setDisabled) # type: ignore
        QtCore.QMetaObject.connectSlotsByName(MainWindow)
        MainWindow.setTabOrder(self.BTN_UPLT, self.BTN_UP)
        MainWindow.setTabOrder(self.BTN_UP, self.BTN_UPRT)
        MainWindow.setTabOrder(self.BTN_UPRT, self.BTN_LT)
        MainWindow.setTabOrder(self.BTN_LT, self.BTN_STOP)
        MainWindow.setTabOrder(self.BTN_STOP, self.BTN_RT)
        MainWindow.setTabOrder(self.BTN_RT, self.BTN_DNLT)
        MainWindow.setTabOrder(self.BTN_DNLT, self.BTN_DN)
        MainWindow.setTabOrder(self.BTN_DN, self.BTN_DNRT)
        MainWindow.setTabOrder(self.BTN_DNRT, self.BOX_COM_LST)
        MainWindow.setTabOrder(self.BOX_COM_LST, self.BTN_SET_COM)
        MainWindow.setTabOrder(self.BTN_SET_COM, self.BOX_FILE)
        MainWindow.setTabOrder(self.BOX_FILE, self.BTN_OPEN)
        MainWindow.setTabOrder(self.BTN_OPEN, self.BTN_RUN)
        MainWindow.setTabOrder(self.BTN_RUN, self.BTN_PAUSE)
        MainWindow.setTabOrder(self.BTN_PAUSE, self.BTN_STOP_PROG)
        MainWindow.setTabOrder(self.BTN_STOP_PROG, self.BTN_SET_H_POS)
        MainWindow.setTabOrder(self.BTN_SET_H_POS, self.BTN_SET_V_POS)
        MainWindow.setTabOrder(self.BTN_SET_V_POS, self.SLIDER_H_POS)
        MainWindow.setTabOrder(self.SLIDER_H_POS, self.SLIDER_V_POS)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.BOX_COM_LST.setCurrentText(_translate("MainWindow", "COM"))
        self.BTN_SET_COM.setText(_translate("MainWindow", "Opened"))
        self.groupBox_2.setTitle(_translate("MainWindow", "Transmit Data Frame"))
        self.groupBox_4.setTitle(_translate("MainWindow", "Recieve Data Frame"))
        self.groupBox_7.setTitle(_translate("MainWindow", "Load PELCO Program"))
        self.LBL_PELCO.setText(_translate("MainWindow", "PELCO"))
        self.BTN_OPEN.setText(_translate("MainWindow", "Open File"))
        self.EXEC_CTRL.setTitle(_translate("MainWindow", "Procgam Execution Control"))
